...
export function AccountForm({ account }: { account?: BankAccount }) {
  ...
  return (
    <form action={act} className="grid gap-2 rounded-2xl border border-slate-200 bg-white p-4 sm:grid-cols-2">
      ...
      <div className="flex items-center gap-2 sm:col-span-2">
        ...
        {!account && <button type="button" onClick={() => setOpen(false)} className="text-sm text-slate-500 hover:underline">Cancel</button>}
