  ...
  return (
    <div className="text-left">
      <form action={action} className="space-y-4">
        <div>
          <label htmlFor="unit_number" className="mb-1 block text-sm font-medium text-slate-700">
            Unit number
          </label>
          <input id="unit_number" name="unit_number" required className={inputCls} placeholder="e.g. 5B" />
        </div>
        <div>
          <label htmlFor="ref_pin" className="mb-1 block text-sm font-medium text-slate-700">
            Reference PIN
          </label>
