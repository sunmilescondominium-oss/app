...
export function DenominationCounter() {
  ...
  return (
    <div className="no-print w-full rounded-xl border border-stone-200 bg-stone-50 p-3">
      <div className="mb-2 flex items-center justify-between">
        <p className="text-xs font-semibold uppercase tracking-wide text-stone-500">Cash count (bills & coins)</p>
        <p className="text-sm font-semibold tabular-nums text-stone-800">Counted: {peso(total)}</p>
      </div>
