  ...
  return (
    <div className="flex flex-wrap items-center justify-end gap-1.5">
      <input
        ...
        placeholder="ID no."
        className="w-20 rounded-lg border border-slate-300 px-2 py-1 text-xs outline-none focus:border-amber-500"
      />
      <input
        value={pass}
      ...
      <button type="button" onClick={() => setOpen(false)} className="text-xs text-slate-400 hover:underline">✕</button>
    </div>
  );
}
