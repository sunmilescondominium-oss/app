  ...
  return (
    <>
      <div className="no-print mb-4 flex items-center justify-between gap-3">
        <PageHeader
        backHref="/dashboard" title="P&L / Reports" subtitle={`${from} to ${to}`} />
      ...
      <section className="mb-6 grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-4">
          <p className="mb-3 text-sm font-semibold text-stone-800">Income vs expense — last 6 months</p>
      ...
      {/* Expenses */}
      <h2 className="mb-2 text-sm font-semibold uppercase tracking-wide text-stone-500">Expenses</h2>
